...
activities = {
    ...
    "Art Club": {
        ...
        "max_participants": 20,
        "participants": ["lisa@mergington.edu", "ravi@mergington.edu"]
    },
    "Drama Society": {
        "description": "Acting, stagecraft, and production of school plays",
        "schedule": "Thursdays, 4:00 PM - 6:30 PM",
        "max_participants": 25,
        "participants": ["hannah@mergington.edu", "omar@mergington.edu"]
    },
    # Intellectual activities
    "Debate Team": {
        "description": "Practice formal debate, public speaking, and competitions",
